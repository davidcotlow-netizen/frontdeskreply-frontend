...
const PLANS = [
  ...
  },
  {
    ...
    name: "Pro",
    price: "$199",
    desc: "Voice AI + premium tools",
    limit: "Unlimited conversations",
    features: [
      "Everything in Growth",
      "Vela Voice AI \u2014 200 min/mo included",
      "Multi-language support \u2014 chat + voice",
      "Weekly email reports (automated)",
      "White-label widget \u2014 custom name, colors",
  ...
  },
  {
    ...
    name: "Enterprise",
    price: "$299",
    desc: "Every channel. Every lead. One dashboard.",
    limit: "Unlimited everything",
    features: [
      "Everything in Pro",
      "Facebook Messenger \u2014 Vela answers DMs",
      "Instagram DMs \u2014 Vela answers DMs",
      "WhatsApp integration \u2014 Vela answers messages",
      "All lead sources unified in one dashboard",
